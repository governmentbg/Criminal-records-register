...
import { EApplicationEWebRequestsComponent } from './e-application-form/eapplication-check-payment-form/tabs/e-application-e-web-requests/e-application-e-web-requests.component';
...
@NgModule({
  declarations: [
    ...
    EApplicationEWebRequestsComponent
  ],
  imports: [
    CoreComponentModule,
