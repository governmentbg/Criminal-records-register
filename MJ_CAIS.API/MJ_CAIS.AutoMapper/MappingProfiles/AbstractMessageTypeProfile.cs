    ...
    public class AbstractMessageTypeProfile : Profile
    {
        public AbstractMessageTypeProfile()
        {
            CreateMap<RequestMessageType, EcrisRequestDTO>()
                ...
                .ForMember(d => d.RequestAuthorityType, opt => opt.MapFrom(src => src.RequestMessageRequestingAuthority.RequestingAuthorityTypeReference.Value))//enum
                ...
                .ForMember(d => d.Nationality, opt => opt.MapFrom(src => src.MessagePerson.PersonNationalityReference[0].Value))//TODO: resolver 
                .ForMember(d => d.CountryPerson, opt => opt.MapFrom(src => src.MessagePerson.PersonBirthPlace.PlaceCountryReference.Value))//reslover PlaceCountryReference
                ...
                .ForMember(d => d.Country, opt => opt.MapFrom(src => src.MessagePerson.PersonAddress[0].AddressPlace.PlaceCountryReference.Value))//resolver PlaceCountryReference
                ...
                //Цел
                .ForMember(d => d.RequestPurposeCategory, opt => opt.MapFrom(src => src.MessagePerson.PersonAddress[0].AddressHouseNumber[0].Value))//enum
