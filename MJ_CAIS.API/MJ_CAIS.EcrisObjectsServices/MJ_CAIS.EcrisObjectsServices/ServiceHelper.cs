    ...
    public class ServiceHelper
    {
        ...
        private static SanctionType[] GetSanctions(BBulletin personBuletin, List<BSanctionCategory> categories, List<BEcrisStanctCateg> ecrisStanctCategs)
        {
            ...
            foreach (var sanction in personBuletin.BSanctions)
            {
                ...
                s.SanctionSuspension.PeriodDuration = ServiceHelper.GetPeriodFromNumbers(sanction.SuspentionDurationYears, sanction.SuspentionDurationMonths,
                ...
                //PnYnMnDTnHnMnS
                s.SanctionSentencedPeriod.PeriodDuration = ServiceHelper.GetPeriodFromNumbers(sanction.DecisionDurationYears, sanction.DecisionDurationMonths,
